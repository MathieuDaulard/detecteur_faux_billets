...
def display_factorial_planes(X_projected, n_comp, pca, axis_ranks, labels=None, alpha=1, illustrative_var=None,labels_new=None, new=None):
    couleur={}
    for d1,d2 in axis_ranks:
        if d2 < n_comp:
            ...
            if new is not None:
                for i,(x,y) in enumerate(new[:,[d1,d2]]):
                    plt.text(x, y+0.2, labels_new[i],fontsize='18', ha='center',va='center',color="red") #couleur[illustrative_var[labels[i]]]
